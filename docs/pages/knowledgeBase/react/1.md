![React面试题.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/717fbcdcdab24964b390fc2f38caeadd~tplv-k3u1fbpfcp-zoom-1.image)
...
不可以，render 阶段 DOM 还没有生成，无法获取 DOM。DOM 的获取需要在 pre-commit 阶段和 commit 阶段： ![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7d76f7ee12c941ceb181bb4650c9e42a~tplv-k3u1fbpfcp-zoom-1.image)
