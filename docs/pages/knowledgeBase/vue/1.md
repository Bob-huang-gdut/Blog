...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a62887948fe64b20906c1c21c8f4478c~tplv-k3u1fbpfcp-zoom-1.image)
...
这种模式实现了 Model和View的数据自动同步，因此开发者只需要专注于数据的维护操作即可，而不需要自己操作DOM。 ![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a827d89a215a48afb6eaca19c9d9cca9~tplv-k3u1fbpfcp-zoom-1.image)
...
在Vue中，对响应式处理利用的是Object.defineProperty对数据进行拦截，而这个方法并不能监听到数组内部变化，数组长度变化，数组的截取变化等，所以需要对这些操作进行hack，让Vue能监听到其中的变化。 ![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6bf1f71451eb44e484502906f5b230d9~tplv-k3u1fbpfcp-zoom-1.image) 那Vue是如何实现让这些数组方法实现元素的实时更新的呢，下面是Vue中对这些方法的封装：
...
**区别：** ![775316ebb4c727f7c8771cc2c06e06dd.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/638e80ba510e4dd4a28d2b5d458b0e5e~tplv-k3u1fbpfcp-zoom-1.image)
...
![bb253b1d177f421741af0e7dd0f52b5e.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d771a464d9674692a4b76bd57a7a7676~tplv-k3u1fbpfcp-zoom-1.image) **（2）mergeOptions 的执行过程**
